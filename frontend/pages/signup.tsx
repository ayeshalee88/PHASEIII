...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // Create user via backend API directly
      ...
      // After successful signup, use credentials provider to establish session
      ...
      // If successful, NextAuth will redirect automatically due to callbackUrl
    } catch (err) {
